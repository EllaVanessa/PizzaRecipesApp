...
public class ProduitService implements IDao<Produit> {
    ...
    private void seed() {
        ...
        create(new Produit("DEEP-DISH SAUSAGE PIZZA", 8, R.mipmap.pizza4, "45 min",
                ...
                "STEP 1:\n\n" +
                        "In a mixing bowl, dissolve yeast in water. Add 1 cup flour, oil and seasonings; beat until smooth. Add enough remaining flour to form a soft dough. Turn onto a floured surface; knead until smooth and elastic, 6-8 minutes.\n\n" +

                        "STEP 2:\n\n" +
                        "Bake and layer ingredients until crust is browned. Yield: 8 slices."
        ));
        ...
        create(new Produit("PESTO CHICKEN PIZZA", 3, R.mipmap.pizza6, "50 min",
                ...
                "STEP 1:\n\n" +
                        ...
                        "STEP 3:\n\n" +
                        "In a large nonstick skillet over medium heat, cook the chicken, onion, peppers and mushrooms in remaining oil until chicken is no longer pink and vegetables are tender. Remove from heat and set aside.\n\n" +

                        "STEP 4:\n\n" +
                        "Punch dough down; roll into a 15-in. circle. Transfer to a pizza pan. Spread with pesto. Top with chicken mixture and cheese. Sprinkle with pepper and remaining salt.\n\n" +

                        "STEP 5:\n\n" +
                        "Bake at 400° for 18-20 minutes or until crust and cheese are lightly browned.\n\n" +

                        "STEP 6:\n\n" +
                        "Freeze option: Wrap and freeze unbaked pizza. To use, bake as directed, increasing time as necessary. Yield: 8 slices."
        ));
        ...
        create(new Produit("LOADED MEXICAN PIZZA", 3, R.mipmap.pizza7, "30 min",
                ...
                "STEP 1:\n\n" +
                        ...
                        "STEP 3:\n\n" +
                        "Bake at 400° for 12-15 minutes or until cheese is melted. Yield: 6 servings."
        ));
        ...
        create(new Produit("BACON CHEESEBURGER PIZZA", 2, R.mipmap.pizza8, "20 min",
                ...
                "Kids of all ages love pizza and cheeseburgers, and this recipe combines them both. My grandchildren usually request pizza for supper when they visit me. They like to help me assemble this version, and they especially enjoy eating it!",
        ...
        create(new Produit("PIZZA MARGHERITA", 1, R.mipmap.pizza9, "30 min",
                ...
                "A classic Pizza Margherita, named for Queen Margherita of Italy, shows off the colors of the Italian flag with red tomatoes, white mozzarella and fresh green basil. It's so scrumptious that you'll be glad the recipe makes not one but two 13-inch pizzas!",
                ...
                "STEP 1:\n\n" +
                        ...
                        "STEP 3:\n\n" +
                        "Punch dough down; divide in half. Roll each portion into a 13-in. circle. Transfer to pizza pans; build up edges slightly. Cover and let rest for 10 minutes.\n\n" +
        ...
        create(new Produit("PEPPERONI-SAUSAGE STUFFED PIZZA", 5, R.mipmap.pizza10, "45 min",
                ...
                "STEP 1:\n\n" +
                        "In a small bowl, dissolve yeast in warm water. In a large bowl, combine oil, salt, sugar, yeast mixture and 1 cup flour; beat until smooth. Stir in enough remaining flour to form a stiff dough.\n\n" +

                        "STEP 2:\n\n" +
                        "Turn dough onto a floured surface; knead until smooth and elastic, about 6-8 minutes. Place in a greased bowl, turning once to grease the top. Cover and let rise until doubled, about 1 hour.\n\n" +

                        "STEP 3:\n\n" +
                        "Preheat oven to 425°. Grease a 13x9-in. baking pan. Punch down dough; divide into three portions. Roll dough and place in pan. Add cheese, sausage, mushrooms and pepperoni.\n\n" +

                        "STEP 4:\n\n" +
                        "Cover with remaining dough, seal edges and bake. Then reduce oven to 375° and continue baking until edges are browned. Let stand before cutting. Yield: 12 servings."
        ));
    }
